        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="id_barang_keluar">Transaction Id Item Out</label>
                    <div class="col-md-4">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="tanggal_keluar">Date Out</label>
                    <div class="col-md-4">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="jumlah_keluar">Total Out</label>
                    <div class="col-md-5">
                        <div class="input-group">
