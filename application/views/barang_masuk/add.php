        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="id_barang_masuk">Transaction Id Item In</label>
                    <div class="col-md-4">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="tanggal_masuk">Date In</label>
                    <div class="col-md-4">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="barang_id">Item</label>
                    <div class="col-md-5">
                        <div class="input-group">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="jumlah_masuk">Total In</label>
                    <div class="col-md-5">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <span class="input-group-text" id="satuan">Unit</span>
                            </div>
                        </div>
                ...
                <div class="row form-group">
                    <div class="col offset-md-4">
                        ...
                        <button type="reset" class="btn btn-secondary"s>Reset</button>
                    </div>
                </div>
                <?= form_close(); ?>
            </div>
