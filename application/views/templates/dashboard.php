...
<head>
    ...
    <title><?= $title; ?> | E storage Management</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex text-white align-items-center bg-primary justify-content-center" href="">
                ...
                <div class="sidebar-brand-text mx-3">E storage Management</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseMaster" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-light py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Master Item:</h6>
                        <a class="collapse-item" href="<?= base_url('satuan'); ?>">Unit Item</a>
                        <a class="collapse-item" href="<?= base_url('jenis'); ?>">Type Item</a>
                        <a class="collapse-item" href="<?= base_url('barang'); ?>">Item Data</a>
                    </div>
                </div>
            </li>
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; E storage Management 2023 </span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">click "Logout" if you sure want to log out.</div>
