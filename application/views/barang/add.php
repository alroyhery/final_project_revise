        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="id_barang">Item Id</label>
                    <div class="col-md-9">
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="jenis_id">Item Type</label>
                    <div class="col-md-9">
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="satuan_id">Item Unit</label>
                    <div class="col-md-9">
                        <div class="input-group">
